...
const bckgMovVariants=
{
    ...
    el1:{top:[-35,-3000],transition:{duration:1.1,ease:"easeIn"}},
    el2:{top:[-35,-3000],transition:{duration:0.6,ease:"easeIn"}},
    el3:{top:[-35,-3000],transition:{duration:0.4,ease:"easeIn"}},
    el4:{top:[-35,-3000],transition:{duration:0.3,ease:"easeIn"}},
    el5:{top:[-35,-3000],transition:{duration:0.2,ease:"easeIn"}},
    el6:{top:[-35,-3000],transition:{duration:0.2,ease:"easeIn"}},
    el7:{top:[-35,-3000],transition:{duration:0.2,ease:"easeIn"}},
    el8:{top:[-35,-3000],transition:{duration:0.2,ease:"easeIn"}},
    el9:{top:[-35,-3000],transition:{duration:0.2,ease:"easeIn"}},
    el10:{top:[-35,-3000],transition:{duration:0.2,ease:"easeIn"}},
    el11:{top:[-35,-3000],transition:{duration:0.2,ease:"easeIn"}},
    el12:{top:[-35,-3000],transition:{duration:0.2,ease:"easeIn"}},
