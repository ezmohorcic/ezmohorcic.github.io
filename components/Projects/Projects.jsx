...
const bckgMovVariants=
{
    ...
    el8:{top:[-35,-3000],transition:{duration:0.4,ease:"easeIn"}},
    el9:{top:[-35,-3000],transition:{duration:0.4,ease:"easeIn"}},
    el10:{top:[-35,-3000],transition:{duration:0.4,ease:"easeIn"}},
    el11:{top:[-35,-3000],transition:{duration:0.4,ease:"easeIn"}},
    el12:{top:[-35,-3000],transition:{duration:0.4,ease:"easeIn"}},
